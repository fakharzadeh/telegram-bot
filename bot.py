...
SYSTEM_PROMPT = "تو یک متخصص تفسیر خواب هستی. فقط و فقط تفسیر خواب انجام می‌دی. خواب‌ها را بر اساس روان‌شناسی نمادین و تحلیل علمی تفسیر می‌کنی. نمادها، احساسات و تصاویر خواب را به صورت علمی و روان‌شناختی تحلیل کن.
FREE_CREDITS = 1
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if text == "📖 درباره تعبیر خواب":
        await update.message.reply_text(
          🌙 *درباره تعبیر خواب*\n\n"
            "خواب‌ها پنجره‌ای به دنیای ناخودآگاه ما هستند.\n\n"
            "این ربات با استفاده از روان‌شناسی نمادین، تصاویر و نمادهای خواب شما را تحلیل و تفسیر می‌کند.\n\n"
            "📌 *نحوه استفاده:*\n"
            "خوابت رو با جزئیات بنویس تا نمادهاش رو تفسیر کنم!\n\n"
            "💡 هرچه جزئیات بیشتری بدی، تفسیر دقیق‌تری دریافت می‌کنی.
            parse_mode="Markdown",
            reply_markup=main_keyboard()
        )
        return
